...
# --- 1. Carregar os Dados Unificados ---
...
df['modulo_afetado'] = df['modulo_afetado'].fillna('Nenhum')

df_encoded = pd.get_dummies(df, columns=['autor_do_mr', 'prioridade', 'modulo_afetado'], drop_first=True)

# A coluna 'id_do_mr' não existe no CSV, então foi removida da lista de exclusão
...
# --- 2. Dividir Dados para Treino e Teste ---
