# qa_pipeline/3_integracao_github_actions.py (Versão Corrigida)
...
# ... (todo o início do arquivo, incluindo as funções extrair_tipo_commit e analisar_novo_pr, permanece o mesmo) ...
...
if __name__ == "__main__":
    ...
    if not all([TOKEN, REPO, PR_NUMBER]):
        # ... (bloco de teste local continua o mesmo)
        ...
        # ... (início do bloco de execução no GitHub continua o mesmo)
        ...
        try:
            ...
            # ✅ CORREÇÃO AQUI: Fazemos as substituições ANTES da f-string.
            # 1. Primeiro, criamos uma variável com a mensagem formatada para o Slack.
            slack_message_formatted = resultado_analise.replace('%', '%25').replace('\n', '%0A').replace('\r', '%0D')
            
            # 2. Depois, usamos essa variável na f-string, sem backslashes.
